...
│   ├── skills/                          pointer README → standalone skill repos (llm-agent-security-principles, agent-adoption-triage, agent-observability-patterns)
...
| [agent-observability-patterns](https://github.com/shimo4228/agent-observability-patterns) (external repo; pointer in `docs/skills/`) | How-to companion to ADR-0006/0005 — replayable audit logs, read-only instruments, shadow-mode validation as installable skills (operational guidance, not judgment) |

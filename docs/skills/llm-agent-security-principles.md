...
This skill is the "how" counterpart to four ADRs in this repository:

- [ADR-0001 Security by Absence](../adr/0001-security-by-absence.md)
- [ADR-0002 Deterministic Prohibition at the Scaffolding Layer](../adr/0002-deterministic-prohibition-at-scaffolding.md)
- [ADR-0003 Untrusted Content Boundary](../adr/0003-untrusted-content-boundary.md)
- [ADR-0004 Single External Adapter per Agent Process](../adr/0004-single-external-adapter.md)

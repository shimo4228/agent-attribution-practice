...
- Scaling a system happens by adding processes, not by adding
...
**Lineage.** This principle first appeared as [contemplative-agent `docs/adr/0015-one-external-adapter-per-agent.md`](https://github.com/shimo4228/contemplative-agent), was generalized in [Agent Knowledge Cycle](https://github.com/shimo4228/agent-knowledge-cycle) v1.x, and extracted into this repository in 2026-04-19.

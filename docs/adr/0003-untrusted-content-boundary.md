...
The list itself is a project-specific concern. This repository does not ship
a canonical list; operators define their own based on their threat model.
The implementation in
[contemplative-agent `src/contemplative_agent/core/config.py`](https://github.com/shimo4228/contemplative-agent)
shows one shape (a plain Python tuple checked case-insensitively).
...
**Lineage.** This principle first appeared as the read-time / write-time rules in [contemplative-agent `docs/adr/0007-security-boundary-model.md`](https://github.com/shimo4228/contemplative-agent), was generalized in [Agent Knowledge Cycle](https://github.com/shimo4228/agent-knowledge-cycle) v1.x as its own ADR, and extracted into this repository in 2026-04-19.

...
Purview Data Security Investigations、AWS Bedrock + OpenAI 統合
(2026-04-28 limited preview として発表)、Google Vertex AI Agent
Builder (Google Cloud Next 2026 で Gemini Enterprise Agent Platform
へ rebrand)、entro.security や oasis.security のような
identity-security スタートアップ ── これらすべてが mechanism
(sub-ms ポリシーゲート、agent identity primitive、sponsor 制度、
cross-vendor 監査、cross-cloud registry sync) を ship しており、
AAP が記録する principle の instance を提供している。
